...
// Add these functions after the existing actorConflict function
...
bool Performance::actorInitialsConflict(Performance* other) {
    ...
    // Check if any actor in this performance has the same initials as
    // any actor in the other performance
    for (int i = 0; i < actorCount; i++) {
