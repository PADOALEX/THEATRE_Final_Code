...
// Add this debug code to loadPerformances function
...
// filepath: /d:/theatre-management-system/Utils.cpp
// Add this function
// Keep only this implementation and remove the duplicate
...
// Update menu function to include option 9
int menu() {
    cout << "\n===============================\n";
...
// filepath: /d:/theatre-management-system/main.cpp
...
// Only including the updated function
